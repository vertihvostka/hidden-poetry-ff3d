...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hidden-poetry-ff3d)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/hidden-poetry-ff3d#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-poetry-ff3d
```

A live public deployment of this template is available at [https://hidden-poetry-ff3d.templates.workers.dev](https://hidden-poetry-ff3d.templates.workers.dev)
